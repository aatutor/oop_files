...
int main()
{
	...
	Employee employee1("Иванов","Менеджер", 1);
	Employee employee2("Петров", "Юрист", 2, 10);
	Employee employee3("Сидорова", "Секретарь", 3, 15);
	Employee employee4("Васечкин", "Директор", 4, 19);
